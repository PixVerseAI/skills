...
Read once when executing a creation chain or handling results. This describes CLI 1.4.0; use installed command help and version-specific behavior on older releases. Canvas and MiniApps keep their own result and concurrency contracts in their capabilities.
